/*=============================================================================================================================================
  ...
  Description:    This script generates a series of reports of broad groupings compared to each budget curve (curve_raw, curve_3pnt, curve_mono).
                  ...
                  The following reports will be generated:
                   ...
                   -  9. Curve Comparison Graph: Compare each quality to its Raw, 3pnt, and Mono curves.
                   - 10. Armor Report: Compares all items and curves, grouped by Armor Type.
...
( @Script, 2,  9, "##  9. Curve Comparison Graph: Compare each quality to its Raw, 3pnt, and Mono curves.                           (v2.4)  ##" ),
( @Script, 2,  9, "##                                                                                                                       ##" ),
( @Script, 2,  9, "##                           - This is a proof-of-concept script, to see if MYSQL can produce visual graphs and charts.  ##" ),

( @Script, 2, 10, "##  10. Armor Report: Compares all items and curves, grouped by Armor Type.                                      (v2.5)  ##" ),
...
/*=============================================================================================================================================
  9. Curve Comparison Graph: Compare each quality to its Raw, 3pnt, and Mono curves.
                              - This is a proof-of-concept script, to see if MYSQL can produce visual graphs and charts.
=============================================================================================================================================*/

SET @VAR_Report9A := 70,     -- unused
    @VAR_Report9B := 0.1;    -- unused

SELECT `output` AS `` FROM ACSBV3_print_info WHERE ( `part`   = 1        OR `part`  = 7 )
                                                OR ( `script` = @Script AND `print` = 9 )
ORDER BY `part`, `auto`;



SELECT CONCAT ( " | Q1  | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;

SELECT

  CONCAT ( " | ", RPAD ( `ItemLevel`, 3, " " ), " | ",

                  RPAD ( RPAD ( "", ROUND ( ( `curve_raw`  * @VAR_Report9B ), 0 ), "=" ), @VAR_Report9A, " " ), " | ",
                  RPAD ( RPAD ( "", ROUND ( ( `curve_3pnt` * @VAR_Report9B ), 0 ), "=" ), @VAR_Report9A, " " ), " | ",
                  RPAD ( RPAD ( "", ROUND ( ( `curve_mono` * @VAR_Report9B ), 0 ), "=" ), @VAR_Report9A, " " ), " | " ) AS ``

FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q1" ORDER BY `ItemLevel`;



SELECT "" AS ``;
SELECT CONCAT ( " | Q2  | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;
...
FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q2" ORDER BY `ItemLevel`;



SELECT "" AS ``;
SELECT CONCAT ( " | Q3  | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;
...
FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q3" ORDER BY `ItemLevel`;



SELECT "" AS ``;
SELECT CONCAT ( " | Q4C | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;
...
FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q4C" ORDER BY `ItemLevel`;



SELECT "" AS ``;
SELECT CONCAT ( " | Q4E | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;
...
FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q4E" ORDER BY `ItemLevel`;



SELECT "" AS ``;
SELECT CONCAT ( " | Q4W | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;
...
FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q4W" ORDER BY `ItemLevel`;



SELECT "" AS ``;
SELECT CONCAT ( " | Q5  | ", RPAD ( "Raw Curve", @VAR_Report9A, " " ), " | ", RPAD ( "3pnt Curve", @VAR_Report9A, " " ), " | ", RPAD ( "Mono Curve", @VAR_Report9A, " " ), " | " ) AS ``;

SELECT

  CONCAT ( " | ", RPAD ( `ItemLevel`, 3, " " ), " | ",

                  RPAD ( RPAD ( "", ROUND ( ( `curve_raw`  * 0.075 ), 0 ), "=" ), @VAR_Report9A, " " ), " | ",
                  RPAD ( RPAD ( "", ROUND ( ( `curve_3pnt` * 0.075 ), 0 ), "=" ), @VAR_Report9A, " " ), " | ",
                  RPAD ( RPAD ( "", ROUND ( ( `curve_mono` * 0.075 ), 0 ), "=" ), @VAR_Report9A, " " ), " | " ) AS ``

FROM ACSBV3_0401A_curve WHERE `CurveName` = "Q5" ORDER BY `ItemLevel`;
