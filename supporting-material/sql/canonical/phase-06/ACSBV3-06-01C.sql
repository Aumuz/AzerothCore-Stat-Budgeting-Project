/*=============================================================================================================================================
  Filename:       ACSBV3-06-01C.sql
  Title:          Create Recommended Weapon Damage Table (part 3 of 5).
  ...
  Description:    This script will generate dmg_min1, dmg_max1, and delay curves for use in creating "Recommended Weapon Damage Table" (ACSBV3-06-01E.sql).
                  This script is part 3 of 5. We will focus on slot_group and `InventoryType` = 21 (Main-Hand).
...
FROM ACSBV3_ref_dataset AS d WHERE d.`class` = 2 AND `InventoryType` = 21 GROUP BY `slot_group`, `ItemLevelBracket`;
...
/*=============================================================================================================================================
  2. Create and Populate Table: ACSBV3_0601C_curve FROM ACSBV3_temp_curve ORDER BY slot_group, ItemLevelBracket
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "2. Create and Populate Table: ACSBV3_0601C_curve FROM ACSBV3_temp_curve ORDER BY slot_group, ItemLevelBracket" );



DROP   TABLE IF EXISTS ACSBV3_0601C_curve;
CREATE TABLE           ACSBV3_0601C_curve          LIKE ACSBV3_temp_curve;
INSERT INTO            ACSBV3_0601C_curve SELECT * FROM ACSBV3_temp_curve ORDER BY `slot_group` ASC, `ItemLevelBracket` ASC;



SELECT * FROM ACSBV3_0601C_curve;



/*=============================================================================================================================================
  3. Apply 3-Point Smoothing Window to Table: ACSBV3_0601C_curve
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "3. Apply 3-Point Smoothing Window to Table: ACSBV3_0601C_curve" );
...
WITH cte AS ( SELECT `slot_group`, `ItemLevelBracket`, AVG ( `min_raw` ) OVER ( PARTITION BY `slot_group`
              ...
              FROM ACSBV3_0601C_curve )

UPDATE ACSBV3_0601C_curve AS curve
  JOIN                cte AS cte
...
/*=============================================================================================================================================
  4. Apply Monotonic Enforcement to Table: ACSBV3_0601C_curve
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "4. Apply Monotonic Enforcement to Table: ACSBV3_0601C_curve" );



SET @SLOT := "", @PREV := 0;

UPDATE ACSBV3_0601C_curve
  JOIN ( SELECT `slot_group`, `ItemLevelBracket`, @PREV := ( CASE WHEN @SLOT = `slot_group` THEN GREATEST ( @PREV, `min_3pnt` )
         ...
         FROM ACSBV3_0601C_curve ORDER BY `slot_group` ASC, `ItemLevelBracket` ASC ) AS mono USING ( `slot_group`, `ItemLevelBracket` )
SET ACSBV3_0601C_curve.`min_mono` = mono.`min_mono`;
...
UPDATE ACSBV3_0601C_curve
  JOIN ( SELECT `slot_group`, `ItemLevelBracket`, @PREV := ( CASE WHEN @SLOT = `slot_group` THEN GREATEST ( @PREV, `max_3pnt` )
         ...
         FROM ACSBV3_0601C_curve ORDER BY `slot_group` ASC, `ItemLevelBracket` ASC ) AS mono USING ( `slot_group`, `ItemLevelBracket` )
SET ACSBV3_0601C_curve.`max_mono` = mono.`max_mono`;
...
UPDATE ACSBV3_0601C_curve
  JOIN ( SELECT `slot_group`, `ItemLevelBracket`, @PREV := ( CASE WHEN @SLOT = `slot_group` THEN GREATEST ( @PREV, `delay_3pnt` )
         ...
         FROM ACSBV3_0601C_curve ORDER BY `slot_group` ASC, `ItemLevelBracket` ASC ) AS mono USING ( `slot_group`, `ItemLevelBracket` )
SET ACSBV3_0601C_curve.`delay_mono` = mono.`delay_mono`;
*/

UPDATE ACSBV3_0601C_curve SET `delay_mono` = `delay_3pnt`;
...
UPDATE ACSBV3_0601C_curve
  JOIN ( SELECT `slot_group`, `ItemLevelBracket`, @PREV := ( CASE WHEN @SLOT = `slot_group` THEN GREATEST ( @PREV, `budget_3pnt` )
         ...
         FROM ACSBV3_0601C_curve ORDER BY `slot_group` ASC, `ItemLevelBracket` ASC ) AS mono USING ( `slot_group`, `ItemLevelBracket` )
SET ACSBV3_0601C_curve.`budget_mono` = mono.`budget_mono`;
...
SELECT "ACSBV3-06-01C.sql Complete: Part 3 of 5. Please run ACSBV3-06-01D.sql next..." AS ``;
