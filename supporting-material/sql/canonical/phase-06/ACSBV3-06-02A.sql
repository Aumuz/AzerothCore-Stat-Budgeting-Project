/*=============================================================================================================================================
  ...
  Title:          Create Recommended Armor Table (part 1 of 6).
  ...
  Description:    This script will generate armor, and armor_cost curves for use in creating "Recommended Armor Table" (ACSBV3-06-02F.sql).
                  This script is part 1 of 6. We will focus on slot_group alone (General Table).
...
FROM ACSBV3_ref_dataset AS d WHERE d.`class` = 4 AND `subclass` > 0 AND d.`armor` > 0 GROUP BY `slot_group`, `ItemLevelBracket`;
...
/*=============================================================================================================================================
  2. Create and Populate Table: ACSBV3_0602A_curve FROM ACSBV3_temp_curve ORDER BY slot_group, ItemLevelBracket
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "2. Create and Populate Table: ACSBV3_0602A_curve FROM ACSBV3_temp_curve ORDER BY slot_group, ItemLevelBracket" );



DROP   TABLE IF EXISTS ACSBV3_0602A_curve;
CREATE TABLE           ACSBV3_0602A_curve          LIKE ACSBV3_temp_curve;
INSERT INTO            ACSBV3_0602A_curve SELECT * FROM ACSBV3_temp_curve ORDER BY `slot_group` ASC, `ItemLevelBracket` ASC;



SELECT * FROM ACSBV3_0602A_curve;



/*=============================================================================================================================================
  3. Apply 3-Point Smoothing Window to Table: ACSBV3_0602A_curve
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "3. Apply 3-Point Smoothing Window to Table: ACSBV3_0602A_curve" );
...
WITH cte AS ( SELECT `slot_group`, `ItemLevelBracket`, AVG ( `armor_raw` ) OVER ( PARTITION BY `slot_group`
              ...
              FROM ACSBV3_0602A_curve )

UPDATE ACSBV3_0602A_curve AS curve
  JOIN                cte AS cte
...
/*=============================================================================================================================================
  4. Apply Monotonic Enforcement to Table: ACSBV3_0602A_curve
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "4. Apply Monotonic Enforcement to Table: ACSBV3_0602A_curve" );



SET @SLOT := "", @PREV := 0;

UPDATE ACSBV3_0602A_curve
  JOIN ( SELECT `slot_group`, `ItemLevelBracket`, @PREV := ( CASE WHEN @SLOT = `slot_group` THEN GREATEST ( @PREV, `armor_3pnt` )
         ...
         FROM ACSBV3_0602A_curve ORDER BY `slot_group`, `ItemLevelBracket` ) AS mono USING ( `slot_group`, `ItemLevelBracket` )
SET ACSBV3_0602A_curve.`armor_mono` = mono.`armor_mono`;
...
UPDATE ACSBV3_0602A_curve
  JOIN ( SELECT `slot_group`, `ItemLevelBracket`, @PREV := ( CASE WHEN @SLOT = `slot_group` THEN GREATEST ( @PREV, `budget_3pnt` )
         ...
         FROM ACSBV3_0602A_curve ORDER BY `slot_group`, `ItemLevelBracket` ) AS mono USING ( `slot_group`, `ItemLevelBracket` )
SET ACSBV3_0602A_curve.`budget_mono` = mono.`budget_mono`;
...
SELECT "ACSBV3-06-02A.sql Complete: Part 1 of 6. Please run ACSBV3-06-02B.sql next..." AS ``;
