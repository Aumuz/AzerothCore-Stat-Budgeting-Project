...
/*=============================================================================================================================================
  1. Create and Populate Table: ACSBV3_0600A_quality
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "1. Create and Populate Table: ACSBV3_0600A_quality" );



DROP   TABLE IF EXISTS ACSBV3_0600A_quality;

CREATE TABLE           ACSBV3_0600A_quality
(
...
INSERT INTO ACSBV3_0600A_quality SELECT   `slot_group`, `RequiredLevelBracket`, `Quality`, MIN( `QualityName` ) AS `QualityName`, SUM( `weight` ) AS `Score`
       FROM ACSBV3_ref_dataset   GROUP BY `slot_group`, `RequiredLevelBracket`, `Quality`;
...
CREATE TEMPORARY TABLE           ACSBV3_temp_quality LIKE ACSBV3_0600A_quality;
...
SELECT * FROM ( SELECT q1.`slot_group`,
                       ...
                       q1.`QualityName`,
                       q1.`Score`
                  FROM ACSBV3_0600A_quality AS q1
                 WHERE q1.`Score` = ( SELECT MAX( `Score` )
                                        FROM ACSBV3_0600A_quality AS q2
  ...
  WHERE `Quality` = ( SELECT MAX( `Quality` )
                        FROM ACSBV3_0600A_quality AS q3
...
/*=============================================================================================================================================
  3. Create and Populate Table: ACSBV3_0600A_itemlevel
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "3. Create and Populate Table: ACSBV3_0600A_itemlevel" );



DROP   TABLE IF EXISTS ACSBV3_0600A_itemlevel;

CREATE TABLE           ACSBV3_0600A_itemlevel
(
...
INSERT INTO ACSBV3_0600A_itemlevel SELECT   `slot_group`, `RequiredLevelBracket`, `ItemLevel`, SUM( `weight` ) AS `Score`
       FROM ACSBV3_ref_dataset     GROUP BY `slot_group`, `RequiredLevelBracket`, `ItemLevel`;
...
CREATE TEMPORARY TABLE           ACSBV3_temp_itemlevel LIKE ACSBV3_0600A_itemlevel;
...
SELECT * FROM ( SELECT i1.`slot_group`,
                       ...
                       i1.`ItemLevel`,
                       i1.`Score`
                  FROM ACSBV3_0600A_itemlevel AS i1
                 WHERE i1.`Score` = ( SELECT MAX( `Score` )
                                        FROM ACSBV3_0600A_itemlevel AS i2
  ...
  WHERE `ItemLevel` = ( SELECT MAX( `ItemLevel` )
                          FROM ACSBV3_0600A_itemlevel AS i3
...
/*=============================================================================================================================================
  5. Create and Populate Table: ACSBV3_0600A_recommend
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "5. Create and Populate Table: ACSBV3_0600A_recommend" );



DROP   TABLE IF EXISTS ACSBV3_0600A_recommend;

CREATE TABLE           ACSBV3_0600A_recommend
(
...
INSERT INTO ACSBV3_0600A_recommend
SELECT
...
SELECT * FROM ACSBV3_0600A_recommend ORDER BY `RequiredLevelBracket` ASC;



/*=============================================================================================================================================
  6. Create and Populate Final Table: ACSBV3_aux_recommend
=============================================================================================================================================*/

CALL ACSBV3_print_header ( "6. Create and Populate Final Table: ACSBV3_aux_recommend" );



DROP   TABLE IF EXISTS ACSBV3_aux_recommend;

CREATE TABLE           ACSBV3_aux_recommend
(
...
INSERT INTO ACSBV3_aux_recommend VALUES
...
( "Staff-Weapon",   "  Not Yet Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available" ),
( "Ranged-Weapon",  "  Not Yet Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available" ),
( "Ranged-Thrown",  "  Not Yet Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available" ),
( "Ranged-Wand",    "  Not Yet Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available" ),
...
( "Back",           "  Not Yet Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available", "No Longer Available" );

UPDATE    ACSBV3_aux_recommend   AS ref
LEFT JOIN ACSBV3_0600A_recommend AS r10 ON ref.`slot_group` = r10.`slot_group` AND r10.`RequiredLevelBracket` = 10
LEFT JOIN ACSBV3_0600A_recommend AS r20 ON ref.`slot_group` = r20.`slot_group` AND r20.`RequiredLevelBracket` = 20
LEFT JOIN ACSBV3_0600A_recommend AS r30 ON ref.`slot_group` = r30.`slot_group` AND r30.`RequiredLevelBracket` = 30
LEFT JOIN ACSBV3_0600A_recommend AS r40 ON ref.`slot_group` = r40.`slot_group` AND r40.`RequiredLevelBracket` = 40
LEFT JOIN ACSBV3_0600A_recommend AS r50 ON ref.`slot_group` = r50.`slot_group` AND r50.`RequiredLevelBracket` = 50
LEFT JOIN ACSBV3_0600A_recommend AS r60 ON ref.`slot_group` = r60.`slot_group` AND r60.`RequiredLevelBracket` = 60
LEFT JOIN ACSBV3_0600A_recommend AS r70 ON ref.`slot_group` = r70.`slot_group` AND r70.`RequiredLevelBracket` = 70
LEFT JOIN ACSBV3_0600A_recommend AS r80 ON ref.`slot_group` = r80.`slot_group` AND r80.`RequiredLevelBracket` = 80
...
SELECT * FROM ACSBV3_aux_recommend;
